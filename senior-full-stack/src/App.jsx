  ...
  return (
    <main className="shell">
      <header>
        ...
        <p>Live incident context for production services.</p>
      </header>
      ...
      <div className="layout">
        <aside className="panel services">
          ...
          {services.map((service) => (
            <button
              key={service.id}
              className={service.id === selectedId ? 'selected' : ''}
        ...
        <section className="content">
          ...
          <section className="stats">
            <article>
              ...
              <strong>{dashboard?.summary.total_incidents ?? '-'}</strong>
            </article>
            <article>
              <span>Active incidents</span>
              <strong>{dashboard?.summary.active_incidents ?? '-'}</strong>
            </article>
            <article>
              <span>Highest severity</span>
              <strong>{dashboard?.summary.highest_severity ?? '-'}</strong>
            </article>
          </section>
